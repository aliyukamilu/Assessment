...
function isotope_init() {
  if (jQuery(".isotope").length) {
    ...
    if (
      ...
      var selector = document.querySelector("select.cws_portfolio_filter")
        .value;
...
function reset_sticky(animated) {
  animated = animated != undefined ? animated : false;
  var sticky_obj_styles = window.sticky_menu.site_header.find(".header_box")[0]
    .style;
  var logo_sticky_adjustments = "";
  if (
    window.sticky_menu.menu_item_height - 24 <
...
jQuery.fn.cws_flex_carousel_controller = function (parent_sel, header_sel) {
  ...
  var show_hide_el_display_prop = window.getComputedStyle(show_hide_el[0])
    .display;
...
function cws_twitter_carousel() {
  jQuery(".twitter-carousel").tweet({
    ...
    template:
      "<a class='fa fa-twitter follow_us' href='{user_url}'></a><p class='tweet_content'>{join}{text}</p>",
  });
